...
public:
	...
	inline static const String ON_CAMERA_ADDED = "ON_CAMERA_ADDED";
	inline static const String ON_CAMERA_REMOVED = "ON_CAMERA_REMOVED";
	inline static const String ON_LIGHT_ADDED = "ON_LIGHT_ADDED";
	inline static const String ON_LIGHT_REMOVED = "ON_LIGHT_REMOVED";
};
