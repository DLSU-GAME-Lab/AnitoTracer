...
namespace Vulkan {
	...
	bool Device::IsMemoryBudgetSupported(VkPhysicalDevice physicalDevice) {
	...
	void Device::QueryMemoryBudget(VkPhysicalDevice physicalDevice, VkDeviceSize& budget, VkDeviceSize& usage) {
